<?php 
error_reporting(0);
if (isset($_COOKIE["user"])){ 		//尝试获取指定的Cookie变量，如果有
	...
	echo"欢迎您:".$_COOKIE["user"]["NameWXH"];			//输出Cookie变量的值
...
<div style="border:1px solid #06f; background:#bbdeff">
  <form method="post" action="WXH149-3-2.php" style="margin:4px;">
    <p>帐号: <input name="NameWXH" type="text" size="12"></p>
    <p>密码: <input name="PW149" type="password" size="12"></p>
