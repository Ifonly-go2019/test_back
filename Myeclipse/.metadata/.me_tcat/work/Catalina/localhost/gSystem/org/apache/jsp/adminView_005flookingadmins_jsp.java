...
public final class adminView_005flookingadmins_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
  List<adminBean> newlist=(List)request.getAttribute("adminlist");
						    
						    if (newlist.size()!=0){
						    	for(int i=0;i<newlist.size();i++){
						    		adminBean admin=new adminBean();
						    		admin=newlist.get(i); //每循环一次后将此时的值保存到对象里
						   
      out.write("\r\n");
      out.write("\t\t\t\t\t\t   <tr> \r\n");
      out.write("\t\t\t\t\t\t    <td>");
      out.print(newlist.get(i).getuNo() );
      out.write("</td> \r\n");
      out.write("\t\t\t\t\t\t    <td>");
      out.print(newlist.get(i).getuPwd() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t    <td>");
      out.print(newlist.get(i).getuInumber() );
      out.write("</td>\t\t\r\n");
      out.write("\t\t\t\t\t\t   </tr> \t\t\r\n");
      out.write("\t\t\t\t\t\t   ");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t    \t<tr><td >数据库中没有数据！</td></tr>\r\n");
      out.write("\t\t\t\t\t\t    \t");
