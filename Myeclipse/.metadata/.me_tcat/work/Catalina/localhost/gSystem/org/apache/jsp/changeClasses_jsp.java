...
public final class changeClasses_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t      \t<a>请填入课程信息</a>\r\n");
      out.write("\t\t\t\t      \r\n");
      out.write("\t\t\t\t      <div class=\"drop\">\r\n");
      out.write("\t\t\t\t      \t\r\n");
      out.write("\t\t\t\t      \t<form action=\"");
      out.print(path );
      out.write("/servlet/classesUpdateServlert\" method=\"get\">\r\n");
      out.write("\t\t\t\t      \t\t<div>\r\n");
      out.write("\t\t\t\t      \t\t\t\r\n");
      out.write("\t\t\t\t      \t\t\t<p>原课程编号</p><input type=\"text\" name=\"cNo\" value=\"");
      out.print(request.getParameter("cNo") );
      out.write("\">\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t      \t\t\t<p>课程名称</p><input type=\"text\" name=\"cName\" value=\"");
      out.print(MyTools.toChinese(request.getParameter("cName")) );
      out.write("\">\r\n");
      out.write("\t\t\t\t      \t\t\t<p>改后课程编号</p><input type=\"text\" name=\"cNoc\" \">\r\n");
      out.write("\t\t\t\t      \t    </div>\r\n");
