...
public final class changeadmins_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t      \t<a>请修改管理员信息</a>\r\n");
      out.write("\t\t\t\t      \r\n");
      out.write("\t\t\t\t      <div class=\"drop\">\r\n");
      out.write("\t\t\t\t      \t\r\n");
      out.write("\t\t\t\t      \t<form action=\"");
      out.print(path );
      out.write("/servlet/adminUpdateServlet\" method=\"get\">\r\n");
      out.write("\t\t\t\t      \t\t<div>\r\n");
      out.write("\t\t\t\t      \t<p>管理员账号<p><input type=\"text\" name=\"uNo\" value=\"");
      out.print(request.getParameter("aNo") );
      out.write("\" >\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<p>密码</p><input type=\"password\" name=\"uPwd\" value=\"");
      out.print(request.getParameter("aPwd") );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<p>邀请码</p><input type=\"text\" name=\"uInumber\" value=\"");
      out.print(request.getParameter("aInumber") );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t      \t\t</div>\r\n");
