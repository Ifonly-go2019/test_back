...
public final class lookingadmins_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t<form action=\"lookingadmins.jsp\" class=\"searchButton\">\r\n");
      out.write("\t\t\t\t\t   <input type=\"text\" name=\"aNo\"  placeholder=\"请输入账号查询\" >\r\n");
      ...
      out.write("\t\t\t\t\t\t");
						...
						for(adminBean admin:newlist){
							...
							out.println("<td><a href=index.jsp>修改</a></td>");
							out.println("</tr>");*/
