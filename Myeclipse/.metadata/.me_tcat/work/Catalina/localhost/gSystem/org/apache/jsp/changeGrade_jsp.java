...
public final class changeGrade_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t      \t<a>请修改学生成绩信息</a>\r\n");
      out.write("\t\t\t\t      \r\n");
      out.write("\t\t\t\t      <div class=\"drop\">\r\n");
      out.write("\t\t\t\t      \t\r\n");
      out.write("\t\t\t\t      \t<form action=\"");
      out.print(path );
      out.write("/servlet/gradeUpdateServlet\" method=\"get\">\r\n");
      out.write("\t\t\t\t      \t\t<div>\r\n");
      out.write("\t\t\t\t      \t<p>学号<p><input type=\"text\" name=\"sId\" value=\"");
      out.print(request.getParameter("sId") );
      out.write("\" >\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<p>课程编号</p><input type=\"text\" name=\"cId\" value=\"");
      out.print(request.getParameter("cId") );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<p>成绩</p><input type=\"text\" name=\"grade\" value=\"");
      out.print(request.getParameter("grade") );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<p>班级</p><input type=\"text\" name=\"sclasses\" value=\"");
      out.print(MyTools.toChinese(request.getParameter("sclasses")) );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t    <p>成绩编号<p><input type=\"text\" name=\"gId\" placeholder=\"必填\" value=\"");
      out.print(MyTools.toChinese(request.getParameter("gId")) );
      out.write("\" >\r\n");
      out.write("\t\t\t\t      \t\t</div>\r\n");
