...
public final class lookingStudents_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t       <form action=\"lookingStudents.jsp\" class=\"searchButton\">\r\n");
      out.write("\t\t\t\t\t   <input type=\"text\" name=\"sNo\"  placeholder=\"请输入学号查询\" >\r\n");
      out.write("\t\t\t\t\t   <input type=\"submit\" value=\"查询\" >\r\n");
      out.write("\t\t\t\t\t   </form>\r\n");
      out.write("\t\t\t\t\t  <span id=\"add\"> <a  href=\"insertStudent.jsp\"  >添加学生</a></span>\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<th class=\"five_th\">班级</th>\r\n");
