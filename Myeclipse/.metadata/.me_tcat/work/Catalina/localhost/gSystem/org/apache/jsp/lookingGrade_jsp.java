...
public final class lookingGrade_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t<form action=\"lookingGrade.jsp\" class=\"searchButton\">\r\n");
      out.write("\t\t\t\t\t   <input type=\"text\" name=\"sId\"  placeholder=\"请输入学号查询\" >\r\n");
      out.write("\t\t\t\t\t   <input type=\"submit\" value=\"查询\" >\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t    <th class=\"ffirst_th\" style=\"width:20px;\">成绩编号</th>\r\n");
