...
public final class changeStudents_005fp_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t      \t<a>请修改学生信息</a>\r\n");
      out.write("\t\t\t\t      \r\n");
      out.write("\t\t\t\t      <div class=\"drop\">\r\n");
      out.write("\t\t\t\t      \t\r\n");
      out.write("\t\t\t\t      \t<form action=\"");
      out.print(path );
      out.write("/servlet/StudentUpdateServlet_p\" method=\"get\">\r\n");
      out.write("\t\t\t\t      \t\t<div>\r\n");
      out.write("\t\t\t\t      \t\t\t<p>学号<p><input type=\"text\" name=\"sNo\" value=\"");
      out.print(request.getParameter("sNo") );
      out.write("\">\r\n");
      out.write("\t\t\t\t      \t\t\t<p>姓名</p><input type=\"text\" name=\"sName\" value=\"");
      out.print(MyTools.toChinese(request.getParameter("sName")) );
      out.write("\">\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t      \t\t\t<p>密码</p><input type=\"text\" name=\"sPwd\" value=\"");
      out.print(request.getParameter("sPwd") );
      out.write("\">\r\n");
      out.write("\t\t\t\t      \t\t\t<p>性别</p><input type=\"text\" name=\"sGender\" value=\"");
      out.print(MyTools.toChinese(request.getParameter("sGender")) );
      out.write("\">\r\n");
      out.write("\t\t\t\t      \t\t\t<p>专业</p><input type=\"text\" name=\"sMajor\" value=\"");
      out.print(MyTools.toChinese(request.getParameter("sMajor")) );
      out.write("\">\r\n");
      out.write("\t\t\t\t      \t\t\t<p>系别</p><input type=\"text\" name=\"sDepart\" value=\"");
      out.print(MyTools.toChinese(request.getParameter("sDepart")) );
      out.write("\">\r\n");
      out.write("\t\t\t\t      \t\t</div>\r\n");
      out.write("\t\t\t\t      \t\t<input type=\"submit\" value=\"点击修改\" id=\"button\">\r\n");
      out.write("\t\t\t\t      \t\r\n");
      out.write("\t\t\t\t      \t</form>\r\n");
      out.write("\t\t\t\t      \r\n");
      out.write("\t\t\t\t      </div>\r\n");
