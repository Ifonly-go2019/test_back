...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.print(path );
      out.write("/servlet/insertSrudentsServlert\" method=\"get\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<p>班级</p><input type=\"text\" name=\"sMajor\">\r\n");
      out.write("\t\t\t\t\t\t<p>系别</p><input type=\"text\" name=\"sDepart\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<input type=\"submit\" value=\"点击添加\" id=\"button\" style=\"margin-left:450px\">\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t\r\n");
