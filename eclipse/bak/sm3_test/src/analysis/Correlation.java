...
//        }
    	...
    	if(keyid==0){
    		currentTraceIndex=t.getTracefirst();
    		lastTraceIndex=currentTraceIndex+t.getTracenumber();
			initProcess(t);
		}
...
//            System.out.println("s2: "+s2[i]);
    ...
    public float[] select(sm3_type t) {
        ...
        return select(t.getData(),rounds,steps);
    }
     ...
     * @return selected data bits
     */
    public float[] select(byte[] data,int rounds,int steps) {
